...
<head>
  ...
  <title>PSR-12: stile e leggibilità (anche per compiti in classe) — PHP Dev Notes</title>
  <meta name="description" content="Codice consistente = review più veloce e meno bug “invisibili”." />
...
<body>
  ...
  <main class="container">
    ...
    <article class="article" aria-label="Articolo del blog">
      <div class="head">
        <div class="feature">
          <img src="assets/posts/psr.svg" alt="Immagine in evidenza: PSR-12: stile e leggibilità (anche per compiti in classe)" />
          <div class="tag">🏷️ Best practice</div>
          <div class="date">20/12/2025</div>
        </div>
      </div>

      <div class="content">
        <h1>PSR-12: stile e leggibilità (anche per compiti in classe)</h1>
        <div class="meta-line">
          <span class="chip">📅 Sabato 20 dicembre 2025</span>
        ...
        <p>Uno stile coerente aiuta: ti fa “vedere” gli errori e facilita le review.</p>
        <ul><li>Indentazione consistente.</li><li>Nomi chiari per variabili e metodi.</li><li>Funzioni piccole, responsabilità singola.</li></ul>
        <pre><code><span class="tok-com">// dopo: leggibile</span>
<span class="tok-kw">if</span> (<span class="tok-var">$ok</span>) {
    <span class="tok-kw">return</span> <span class="tok-str">'yes'</span>;
}
<span class="tok-kw">return</span> <span class="tok-str">'no'</span>;</code></pre>
