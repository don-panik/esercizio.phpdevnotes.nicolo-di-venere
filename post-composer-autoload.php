...
<head>
  ...
  <title>Composer e autoload: progetto ordinato, require zero — PHP Dev Notes</title>
  <meta name="description" content="PSR-4 e autoload: organizzare src/ come si fa nei progetti reali." />
...
<body>
  ...
  <main class="container">
    ...
    <article class="article" aria-label="Articolo del blog">
      <div class="head">
        <div class="feature">
          <img src="assets/posts/composer.svg" alt="Immagine in evidenza: Composer e autoload: progetto ordinato, require zero" />
      ...
      <div class="content">
        <h1>Composer e autoload: progetto ordinato, require zero</h1>
        <div class="meta-line">
          <span class="chip">📅 Venerdì 2 gennaio 2026</span>
        ...
        <p>Composer può generare l'autoload PSR-4: namespace → cartella. Perfetto per passare a OOP.</p>
        <pre><code><span class="tok-com">// composer.json (estratto)</span>
{
  <span class="tok-str">"autoload"</span>: { <span class="tok-str">"psr-4"</span>: { <span class="tok-str">"App\\"</span>: <span class="tok-str">"src/"</span> } }
}</code></pre>
        <p>Poi: <code>composer dump-autoload</code> e includi <code>vendor/autoload.php</code>.</p>
